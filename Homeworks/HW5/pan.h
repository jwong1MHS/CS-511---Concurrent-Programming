...
#define _nstates2	11	/* p3 */
#define minseq2	64
#define maxseq2	73
#define _endstate2	10

#define _nstates1	36	/* :init: */
#define minseq1	29
#define maxseq1	63
#define _endstate1	35

#define _nstates0	30	/* nnode */
#define minseq0	0
#define maxseq0	28
...
#define Air1	(sizeof(P1) - Offsetof(P1, _4_2_proc) - 1*sizeof(int))
